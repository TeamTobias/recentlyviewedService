...
import com.tobias.recentlyviewedservice.config.KafkaSseConsumer;
import com.tobias.recentlyviewedservice.config.KafkaSseProducer;
...
@RestController
@RequestMapping("/api/recentlyviewed-service-kafka")
public class RecentlyviewedServiceKafkaResource {

    private final Logger log = LoggerFactory.getLogger(RecentlyviewedServiceKafkaResource.class);
    ...
    public RecentlyviewedServiceKafkaResource(@Qualifier(KafkaSseProducer.CHANNELNAME) MessageChannel output) {
        this.output = output;
    }
